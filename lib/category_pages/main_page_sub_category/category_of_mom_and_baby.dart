...
class CategoryOfMomAndBaby extends StatefulWidget {
  final String mainCategoryName;
  const CategoryOfMomAndBaby({Key? key, required this.mainCategoryName}) : super(key: key);
  @override
  State<CategoryOfMomAndBaby> createState() => _CategoryOfMomAndBabyState();
}
class _CategoryOfMomAndBabyState extends State<CategoryOfMomAndBaby> {
  ...
  Future<void> getSkinCareCategories() async {
    ...
    final response = await http.get(
      Uri.parse('${Config.url}/products/categories?parent=208'),
      headers: {
        'Authorization': 'Basic ' +
