...
class CategoryOfMakeup extends StatefulWidget {
  final String mainCategoryName;
  const CategoryOfMakeup({Key? key, required this.mainCategoryName}) : super(key: key);
  @override
  State<CategoryOfMakeup> createState() => _CategoryOfMakeupState();
}
class _CategoryOfMakeupState extends State<CategoryOfMakeup> {
  ...
  @override
  List<int>pageId=[159,137,123,146,154];
  ...
  Future<void> getSkinCareCategories() async {
    ...
    final response = await http.get(
      Uri.parse('${Config.url}/products/categories?parent=52'),
      headers: {
        'Authorization': 'Basic ' +
          ...
          Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context,index){
                  ...
                  print("proooooooooooo= $_pageController");
