...
class CategoryOfHair extends StatefulWidget {
  final String mainCategoryName;
  const CategoryOfHair({Key? key, required this.mainCategoryName}) : super(key: key);
  @override
  State<CategoryOfHair> createState() => _CategoryOfHairState();
}
class _CategoryOfHairState extends State<CategoryOfHair> {
  ...
  @override
  List<int>pageId=[187,53,199,193];
  ...
  Future<void> getSkinCareCategories() async {
    ...
    final response = await http.get(
      Uri.parse('${Config.url}/products/categories?parent=204'),
      headers: {
        'Authorization': 'Basic ' +
