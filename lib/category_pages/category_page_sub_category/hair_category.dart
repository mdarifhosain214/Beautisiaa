...
class HairCategory extends StatefulWidget {
  const HairCategory({Key? key}) : super(key: key);

  @override
  State<HairCategory> createState() => _HairCategoryState();
}

class _HairCategoryState extends State<HairCategory> {
