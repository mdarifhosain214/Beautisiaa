...
class BrandsCategory extends StatefulWidget {
  const BrandsCategory({Key? key}) : super(key: key);
  @override
  State<BrandsCategory> createState() => _BrandsCategoryState();
}

class _BrandsCategoryState extends State<BrandsCategory> {
